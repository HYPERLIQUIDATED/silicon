...
pub struct ClaimBInstructionAccounts {
...
impl ClaimB {
    pub const DISCRIMINATOR: [u8; 8] = [213, 21, 159, 131, 21, 57, 2, 67];
...
impl ArrangeAccounts for ClaimB {
    type ArrangedAccounts = ClaimBInstructionAccounts;
    ...
    fn arrange_accounts(accounts: &[AccountMeta]) -> Option<Self::ArrangedAccounts> {
        ...
        Some(ClaimBInstructionAccounts {
            claimer_b,
            claimer_a,
            fee_authority,
