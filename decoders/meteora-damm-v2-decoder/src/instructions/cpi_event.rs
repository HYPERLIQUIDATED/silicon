...
use crate::events::{
    ...
    EvtLockPosition, EvtPermanentLockPosition, EvtSetPoolStatus, EvtSplitPosition2, EvtSwap2,
    EvtUpdatePoolFees, EvtUpdateRewardDuration, EvtUpdateRewardFunder, EvtWithdrawIneligibleReward,
};
